...
`)();let a=class{constructor(i){n(this,"renderer");n(this,"ObservedProperties",["notification"]);n(this,"notification");this.renderer=i}mount(){this.renderer.emitEvent("rendered")}onDismiss(i){i.preventDefault(),this.notification.dismiss()}render(){return this.notification&&this.notification.message.content?e`
      ...
      `:e`<div></div>`}};a=c([f({selector:"ui-notification-message",standalone:!0,styles:l,deps:[s]}),m("design:paramtypes",[s])],a);export{a as NotificationMessage};
