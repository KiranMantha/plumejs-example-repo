(window.webpackJsonp=window.webpackJsonp||[]).push([[1],{11:function(e,a,t){var n=t(3),s=t(49);(a=n(!1)).i(s),a.push([e.i,".container{padding:0 0.5rem}.mt-20{margin-top:20px}.mb-20{margin-bottom:20px}.mr-10{margin-right:10px}\n",""]),e.exports=a},19:function(e,a,t){t(51),e.exports=t(50)},50:function(e,a,t){t.e(0).then(t.t.bind(null,52,7))},51:function(e,a,t){"use strict";t.r(a),t.d(a,"AppComponent",(function(){return m}));var n=t(0),s=t(1),i=t(8);var r={username:{greet:"my name is {name}"}};var o={username:{greet:"je m`appelle {name}"}},l=t(11),p=t.n(l);console.log("styles.scss result using import",p.a),Object(i.registerToggleComponent)(),Object(i.registerMultiSelectComponent)();let m=class AppComponent{constructor(e,a){this.router=e,this.translations=a,this.showNav=!1,this.routes=[{path:"",redirectTo:"/home"},{path:"/home",template:"<sample-ele></sample-ele>",templatePath:()=>t.e(6).then(t.bind(null,54))},{path:"/controls",template:"<plume-comp></plume-comp>",templatePath:()=>t.e(5).then(t.bind(null,57))},{path:"/persons/:id",template:"<persons-list></persons-list>",templatePath:()=>t.e(4).then(t.bind(null,55)),canActivate:()=>!!localStorage.getItem("plumejs")||(this.router.navigateTo("/home"),!1)},{path:"/form",template:"<sample-form></sample-form>",templatePath:()=>t.e(7).then(t.bind(null,56))}],this.navigate=(e,a)=>{e.preventDefault(),this.router.navigateTo(a)},s.Router.registerRoutes(this.routes),a.setTranslate(r,"en"),a.setTranslate(o,"fr"),a.setDefaultLanguage("en")}_displayNav(){this.showNav=!this.showNav,this.update()}render(){return s.html`
