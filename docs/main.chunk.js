(window.webpackJsonp=window.webpackJsonp||[]).push([[1],{17:function(e,a,t){t(44),e.exports=t(43)},43:function(e,a,t){t.e(0).then(t.t.bind(null,45,7))},44:function(e,a,t){"use strict";t.r(a),t.d(a,"AppComponent",(function(){return l}));var s=t(0),n=t(1),i=t(8);var r={username:{greet:"my name is {name}"}};var o={username:{greet:"je m`appelle {name}"}};Object(i.registerToggleComponent)(),Object(i.registerMultiSelectComponent)();let l=class AppComponent{constructor(e,a){this.router=e,this.translations=a,this.showNav=!1,this.routes=[{path:"",redirectTo:"/home"},{path:"/home",template:"<sample-ele></sample-ele>",templatePath:()=>t.e(6).then(t.bind(null,46))},{path:"/controls",template:"<plume-comp></plume-comp>",templatePath:()=>t.e(5).then(t.bind(null,49))},{path:"/persons/:id",template:"<persons-list></persons-list>",templatePath:()=>t.e(4).then(t.bind(null,47)),canActivate:()=>!!localStorage.getItem("plumejs")||(this.router.navigateTo("/home"),!1)},{path:"/form",template:"<sample-form></sample-form>",templatePath:()=>t.e(7).then(t.bind(null,48))}],this.navigate=(e,a)=>{e.preventDefault(),this.router.navigateTo(a)},n.Router.registerRoutes(this.routes),a.setTranslate(r,"en"),a.setTranslate(o,"fr"),a.setDefaultLanguage("en")}_displayNav(){this.showNav=!this.showNav,this.update()}render(){return n.html`
			...
			<slot></slot>
    `}};l=Object(s.__decorate)([Object(n.Component)({selector:"app-root",styleUrl:"styles.scss",useShadow:!1,root:!0}),Object(s.__metadata)("design:paramtypes",[n.Router,n.TranslationService])],l)}},[[17,2,3]],[0]]);