(window.webpackJsonp=window.webpackJsonp||[]).push([[0],{18:function(e,a,t){var n=t(3),s=t(50);(a=n(!1)).i(s),a.push([e.i,".container{padding:0 0.5rem}.mt-20{margin-top:20px}.mb-20{margin-bottom:20px}.mr-10{margin-right:10px}\n",""]),e.exports=a},51:function(e,a,t){"use strict";t.r(a),t.d(a,"AppComponent",(function(){return m}));var n=t(0),s=t(1),r=t(8);var i={username:{greet:"my name is {name}"}};var o={username:{greet:"je m`appelle {name}"}},l=t(18),p=t.n(l);Object(r.registerToggleComponent)(),Object(r.registerMultiSelectComponent)();let m=(()=>{let e=class AppComponent{constructor(e,a){this.router=e,this.translations=a,this.showNav=!1,this.routes=[{path:"",redirectTo:"/home"},{path:"/home",template:"<sample-ele></sample-ele>",templatePath:()=>t.e(5).then(t.bind(null,55))},{path:"/controls",template:"<plume-comp></plume-comp>",templatePath:()=>t.e(4).then(t.bind(null,56))},{path:"/persons/:id",template:"<persons-list></persons-list>",templatePath:()=>t.e(3).then(t.bind(null,53)),canActivate:()=>!!localStorage.getItem("plumejs")||(this.router.navigateTo("/home"),!1)},{path:"/form",template:"<sample-form></sample-form>",templatePath:()=>t.e(6).then(t.bind(null,54))}],this.navigate=(e,a)=>{e.preventDefault(),this.router.navigateTo(a)},s.Router.registerRoutes(this.routes),a.setTranslate(i,"en"),a.setTranslate(o,"fr"),a.setDefaultLanguage("en")}_displayNav(){this.showNav=!this.showNav,this.update()}render(){return s.html`
    ...
    `}};return e=Object(n.__decorate)([Object(s.Component)({selector:"app-root",styles:p.a,useShadow:!1,root:!0}),Object(n.__metadata)("design:paramtypes",[s.Router,s.TranslationService])],e),e})()}},[[51,1,2]]]);