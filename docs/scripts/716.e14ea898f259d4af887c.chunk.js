"use strict";(self.webpackChunkplumejs_example_repo=self.webpackChunkplumejs_example_repo||[]).push([[716],{7716:function(t,e,o){o.r(e),o.d(e,{NestedTable:function(){return d}});var a=o(655),r=o(3069);let n=class{users=[];mount(){fetch("https://jsonplaceholder.typicode.com/users").then((t=>t.json())).then((t=>{this.users=t,console.log("no renderer")}))}onFormSubmit(t){t.preventDefault();const e=new FormData(t.currentTarget);console.log(JSON.stringify(Object.fromEntries(e.entries()),null,4))}render(){return this.users.length?r.dy`
