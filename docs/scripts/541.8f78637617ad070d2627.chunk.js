"use strict";(self.webpackChunkplumejs_example_repo=self.webpackChunkplumejs_example_repo||[]).push([[541],{541:function(e,l,t){t.r(l);var r=t(674),o=t(968),s=t(632);let i=class{renderer;sampleform;multiSelectChangehandler;jsonRef;errorsRef;hasErrors=!1;isSubmitted=!1;dropdownOptions={options:[{label:"Option 1",value:"o1"},{label:"Option 2",value:"o2"},{label:"Option 3",value:"o3"},{label:"Option 4",value:"o4"}],multiple:!0,buttonText:e=>0===e.length?"None selected":e.length>3?e.length+" selected":e.map((e=>e.label)).join(", ")};dropdownRef;constructor(e){this.renderer=e}beforeMount(){this.sampleform=new s.FormBuilder({email:["",[s.Validators.required,s.Validators.pattern(/^[a-z0-9]((\.|\+)?[a-z0-9]){5,}@gmail\.com$/)]],password:"",checkme:!0,option:"1",options:[[]],gender:""}),this.multiSelectChangehandler=this.sampleform.register("options").attrs.onchange}submitForm(e){e.preventDefault(),this.hasErrors=!!this.sampleform.errors.size,this.sampleform.valid&&alert("form submitted successfully"),console.log(this.sampleform.value)}resetForm(){this.sampleform.reset()}registerWithoutValue(e){const l=this.sampleform.register(e);return delete l.attrs.value,l}render(){return o.html`
      <div>
        <form
    ...
    `}};i=(0,r.Cg)([(0,o.Component)({selector:"sample-form",deps:[o.Renderer]})],i)}}]);
