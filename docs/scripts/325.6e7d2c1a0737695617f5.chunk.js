"use strict";(self.webpackChunkplumejs_example_repo=self.webpackChunkplumejs_example_repo||[]).push([[325],{325:function(e,t,s){s.r(t);var o=s(674),n=s(968);let r=class{render(){return n.html`<p>my styles are emulated</p>`}};r=(0,o.Cg)([(0,n.Component)({selector:"emulated-styles",styles:"\n    :host(.color-1) p { color: green; }\n    :host(.color-2) p { color: blue; }\n    :host(.color-3) p { color: red; }\n  "})],r);let l=class{testMeth(){console.log("testmethod in sample service")}};l=(0,o.Cg)([(0,n.Injectable)()],l);let i=class{sampleSrvc;constructor(e){this.sampleSrvc=e}testMeth(){this.sampleSrvc.testMeth()}getUsers(){return fetch("https://api.github.com/users?since=135")}};i=(0,o.Cg)([(0,n.Injectable)({deps:[l]})],i);let c=class{testSrvc;renderer;test;greeting="hello world";outCount;props;inputField;testEleRef;constructor(e,t){this.testSrvc=e,this.renderer=t,this.test="sample 123",this.props={name:this.test}}beforeMount(){console.log("before mounting...")}mount(){console.log("component loaded"),console.log(this.inputField),this.testSrvc.testMeth(),this.testEleRef.setProps({testprops:this.props})}unmount(){console.log("component unloaded")}enablePersonsRoute(){window.localStorage.setItem("@plumejs/core","now persons route is activated")}disablePersonsRoute(){window.localStorage.removeItem("@plumejs/core")}updateProps(){this.testEleRef.setProps({testprops:{name:"sample 123"}})}count(e){this.test=e,this.props.name=e,this.testEleRef.setProps({testprops:this.props})}getRef(){console.log(this.inputField)}render(){return n.html`
    ...
    `}};c=(0,o.Cg)([(0,n.Component)({selector:"sample-ele",deps:[i,n.Renderer]})],c);let p=class{renderer;static observedProperties=["testprops"];testprops;constructor(e){this.renderer=e}render(){return this.testprops?n.html`
        <div>
      ...
      `:n.html``}counts(){this.renderer.emitEvent("count","testing from click")}change(e){this.renderer.emitEvent("count",e)}mount(){console.log("component loaded"),console.log("props: ",this.testprops)}unmount(){console.log("component unloaded")}};p=(0,o.Cg)([(0,n.Component)({selector:"test-ele",deps:[n.Renderer]})],p)}}]);
