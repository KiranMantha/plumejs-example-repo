"use strict";(self.webpackChunkplumejs_example_repo=self.webpackChunkplumejs_example_repo||[]).push([[270],{270:function(t,e,o){o.r(e),o.d(e,{NestedTable:function(){return l}});var a=o(674),n=o(968);let r=class{users=[];mount(){fetch("https://jsonplaceholder.typicode.com/users").then((t=>t.json())).then((t=>{this.users=t,console.log("no renderer")}))}onFormSubmit(t){t.preventDefault();const e=new FormData(t.currentTarget);console.log(JSON.stringify(Object.fromEntries(e.entries()),null,4))}render(){return this.users.length?n.html`
    ...
    `}};l=(0,a.Cg)([(0,n.Component)({selector:"app-nested-table"})],l)}}]);
