"use strict";(self.webpackChunkplumejs_example_repo=self.webpackChunkplumejs_example_repo||[]).push([[218],{218:function(o,e,t){t.r(e);var s=t(655),n=t(366),l=t(558);let d=class{modalsrvc;ObservedProperties=["nestedModalData"];nestedModalData;constructor(o){this.modalsrvc=o}openAnotherModal(){const o=this.modalsrvc.show({renderTemplate:()=>n.dy`<div>i'm nested modal</div>`,modalTitle:"nested modal",modalClass:"nested-class"});o.onOpen.subscribe((()=>{console.log("nested modal open")})),o.onClose.subscribe((()=>{console.log("nested modal closed")}))}render(){return this.nestedModalData?n.dy`
    ...
    `}};a=(0,s.gn)([(0,n.wA)({selector:"plume-comp",deps:[i.F,l.Z7,l.gq]})],a)}}]);
