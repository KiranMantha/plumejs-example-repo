"use strict";(self.webpackChunkplumejs_example_repo=self.webpackChunkplumejs_example_repo||[]).push([[468],{335:function(e,s,t){var r=t(354),n=t.n(r),o=t(314),a=t.n(o)()(n());a.push([e.id,".test{list-style:none;margin:0;padding:0}.test li{color:#000}","",{version:3,sources:["webpack://./src/persons/persons-list.scss"],names:[],mappings:"AAEA,MACE,eAAA,CACA,QAAA,CACA,SAAA,CACA,SACE,UAPG",sourcesContent:["$grey: #000;\n\n.test {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  li {\n    color: $grey;\n  }\n}"],sourceRoot:""}]),s.A=a},468:function(e,s,t){t.r(s);var r=t(674),n=t(968);let o=class{renderer;static observedProperties=["personDetails"];constructor(e){this.renderer=e}personDetails;sendDataToParent(){this.renderer.emitEvent("userclick",this.personDetails)}render(){return this.personDetails?.name?n.html`
      ...
      `:n.html`<div></div>`}};o=(0,r.Cg)([(0,n.Component)({selector:"person-details",deps:[n.Renderer]})],o);var a=t(766),i=t(335);let l=class{getPersons(){return fetch("https://jsonplaceholder.typicode.com/users").then((e=>e.json()))}};l=(0,r.Cg)([(0,n.Injectable)()],l);let c=class{personSrvc;router;users=[];selectedPerson;routeData;constructor(e,s){this.personSrvc=e,this.router=s}mount(){this.personSrvc.getPersons().then((e=>{this.users=e})),this.loadRouteData()}loadRouteData(){this.router.getCurrentRoute().subscribe((e=>{this.routeData={path:e.path,routeParams:Object.fromEntries(e.routeParams),queryParams:Object.fromEntries(e.queryParams),state:e.state}}))}onUserClick(e){console.log("data from app-person-details comp: ",e)}updateUrl(){this.router.navigateTo(`/persons/${Math.random()}/testuser?a=${Math.random()}`)}render(){return n.html`
      <h3>Persons route</h3>
      ...
      ></person-details>
    `}};c=(0,r.Cg)([(0,n.Component)({selector:"persons-list",styles:i.A,deps:[l,a.I]})],c)}}]);
