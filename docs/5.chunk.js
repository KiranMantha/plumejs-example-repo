(window.webpackJsonp=window.webpackJsonp||[]).push([[5],{53:function(t,e,s){"use strict";s.r(e);var o=s(0),n=s(1);(()=>{let t=class EmulatedStylesComp{render(){return n.html`<p class='test-emulation'>my styles are emulated</p>`}};t=Object(o.__decorate)([Object(n.Component)({selector:"emulated-styles",styles:".test-emulation { color: green;}"})],t)})();let l=(()=>{let t=class SampleService{constructor(){}testMeth(){console.log("testmethod in sample service")}};return t=Object(o.__decorate)([Object(n.Injectable)(),Object(o.__metadata)("design:paramtypes",[])],t),t})(),c=(()=>{let t=class TestService{constructor(t){this.sampleSrvc=t}testMeth(){this.sampleSrvc.testMeth()}getUsers(){return fetch("https://api.github.com/users?since=135")}};return t=Object(o.__decorate)([Object(n.Injectable)(),Object(o.__metadata)("design:paramtypes",[l])],t),t})();(()=>{let t=class TestEle{constructor(){this.testprops={}}render(){return n.html`
			<div>
