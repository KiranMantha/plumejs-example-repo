(window.webpackJsonp=window.webpackJsonp||[]).push([[5],{55:function(t,e,s){"use strict";s.r(e);var o=s(0),n=s(1);let l=class EmulatedStylesComp{render(){return n.html`<p class='test-emulation'>my styles are emulated</p>`}};l=Object(o.__decorate)([Object(n.Component)({selector:"emulated-styles",styles:".test-emulation { color: green;}"})],l);let c=class SampleService{constructor(){}testMeth(){console.log("testmethod in sample service")}};c=Object(o.__decorate)([Object(n.Injectable)(),Object(o.__metadata)("design:paramtypes",[])],c);let i=class TestService{constructor(t){this.sampleSrvc=t}testMeth(){this.sampleSrvc.testMeth()}getUsers(){return fetch("https://api.github.com/users?since=135")}};i=Object(o.__decorate)([Object(n.Injectable)(),Object(o.__metadata)("design:paramtypes",[c])],i);let a=class TestEle{constructor(){this.testprops={}}render(){return n.html`
			<div>
