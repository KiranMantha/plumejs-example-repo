(window.webpackJsonp=window.webpackJsonp||[]).push([[4],{56:function(t,e,o){"use strict";o.r(e);var s=o(0),l=o(1),i=o(8);(()=>{let t=class NestedModal{constructor(t){this.modalsrvc=t,this.nestedModalData={}}openAnotherModal(){const t=this.modalsrvc.show({renderTemplate:()=>l.html`<div>i'm nested modal</div>`,modalTitle:"nested modal",modalClass:"nested-class"});t.onOpen.subscribe(()=>{console.log("nested modal open")}),t.onClose.subscribe(()=>{console.log("nested modal closed")})}render(){return l.html`
		...
		`}};Object(s.__decorate)([Object(l.Input)(),Object(s.__metadata)("design:type",Object)],t.prototype,"nestedModalData",void 0),t=Object(s.__decorate)([Object(l.Component)({selector:"nested-modal"}),Object(s.__metadata)("design:paramtypes",[i.ModalService])],t)})(),(()=>{let t=class PlumeComponents{constructor(t,e){this.modalsrvc=t,this.notifySrvc=e,this.toggleInput={onchange:this.onToggleChange.bind(this),onText:"ON",offText:"OFF"},this.multiselectToggles={enableMultiselect:{onchange:t=>{this.multiSelectOptions.multiple=t,this.multiSelectOptions.resetWidget=!0,this.update()}},disableDropdown:{onchange:t=>{this.multiSelectOptions.disableDropdown=t,this.multiSelectOptions.resetWidget=!0,this.update()}},enableFilter:{onchange:t=>{this.multiSelectOptions.enableFilter=t,this.multiSelectOptions.resetWidget=!0,this.update()}}},this.multiSelectOptions={data:[{name:"option1"},{name:"option2"},{name:"option3"},{name:"option4"},{name:"option5"}],selectedValues:[{name:"option1"},{name:"option2"}],displayField:"name",multiple:!1,disableDropdown:!1,buttonText:t=>0===t.length?"None selected":t.length>3?t.length+" selected":t.map(t=>t.name).join(", "),onchange:t=>{console.log(t)}}}openModal(){const t=this.modalsrvc.show({renderTemplate:()=>l.html`<nested-modal nestedModalData=${{message:"Hello World"}}></nested-modal>`,modalTitle:"testing modal",modalClass:"sample-class"});t.onOpen.subscribe(()=>{console.log("main modal open",t.Id)}),t.onClose.subscribe(()=>{console.log("main modal closed")})}notify(){this.notifySrvc.sendMessage("hello world",i.NotificationType.Info)}notifyWithAutoHide(){this.notifySrvc.sendMessage("hello world",i.NotificationType.Info,!0)}onToggleChange(t){console.log(t)}render(){return l.html`
			...
			`}};t=Object(s.__decorate)([Object(l.Component)({selector:"plume-comp"}),Object(s.__metadata)("design:paramtypes",[i.ModalService,i.NotificationService])],t)})()}}]);