(window.webpackJsonp=window.webpackJsonp||[]).push([[3],{52:function(e,t,s){(t=s(3)(!1)).push([e.i,".test{list-style:none;margin:0;padding:0}.test li{color:#000}\n",""]),e.exports=t},53:function(e,t,s){"use strict";s.r(t);var r=s(0),o=s(1),a=s(52),i=s.n(a);let n=class PersonService{getPersons(){return fetch("https://jsonplaceholder.typicode.com/users").then(e=>e.json())}};n=Object(r.__decorate)([Object(o.Injectable)()],n);let l=class PersonsList{constructor(e,t){this.personSrvc=e,this.router=t,this.data=[],this.persondetails={},console.log("current route ",this.router.getCurrentRoute())}mount(){this.personSrvc.getPersons().then(e=>{this.data=e,this.update()})}alertName(e){this.persondetails=e,this.update()}render(){return o.html`
