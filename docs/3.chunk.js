(window.webpackJsonp=window.webpackJsonp||[]).push([[3],{50:function(e,t,s){(t=s(3)(!1)).push([e.i,".test{list-style:none;margin:0;padding:0}.test li{color:#000}\n",""]),e.exports=t},51:function(e,t,s){"use strict";s.r(t);var r=s(0),o=s(1),a=s(50),i=s.n(a);let n=(()=>{let e=class PersonService{getPersons(){return fetch("https://jsonplaceholder.typicode.com/users").then(e=>e.json())}};return e=Object(r.__decorate)([Object(o.Injectable)()],e),e})();(()=>{let e=class PersonsList{constructor(e,t){this.personSrvc=e,this.router=t,this.data=[],this.persondetails={},console.log("current route ",this.router.getCurrentRoute())}mount(){this.personSrvc.getPersons().then(e=>{this.data=e,this.update()})}alertName(e){this.persondetails=e,this.update()}render(){return o.html`
